...
class ConverseRequest(BaseModel):
    ...
    document_ids: List[StrictInt] = Field(description="The IDs of the documents to ask the question.")
    mode: Optional[StrictStr] = Field(default=None, description="The mode of the model, either 'default' or 'advanced'.")
    __properties: ClassVar[List[str]] = ["question", "document_ids", "mode"]
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in ('default', 'advanced'):
