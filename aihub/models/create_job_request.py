...
class CreateJobRequest(BaseModel):
    ...
    CreateJobRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the app to run.")
    app_id: Optional[StrictStr] = Field(default=None, description="The ID of the app to run.")
    batch_id: StrictInt = Field(description="Batch ID.")
    __properties: ClassVar[List[str]] = ["name", "app_id", "batch_id"]
