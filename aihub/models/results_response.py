...
class ResultsResponse(BaseModel):
    ...
    ResultsResponse
    """ # noqa: E501
    files: Optional[Dict[str, FileResult]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _field_dict = {}
        if self.files:
            for _key in self.files:
                if self.files[_key]:
                    _field_dict[_key] = self.files[_key].to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "files": dict(
                (_k, FileResult.from_dict(_v))
                for _k, _v in obj.get("files").items()
            )
