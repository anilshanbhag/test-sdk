...
class TestConverseRequest(unittest.TestCase):
    """ConverseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConverseRequest:
        """Test ConverseRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConverseRequest`
        """
        model = ConverseRequest()
        if include_optional:
